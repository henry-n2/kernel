...
def SaveSettings(self):
    # get api keys
    api_key = self.VirusTotalApiKey.text("8530c5fc9992bc8692029c6ca09c3c913172f6acbb378053ab1e40761bfba598")
...
"image: url(:/res/SideBar/settings.svg);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", f"-KERNEL- [v{VERSION}] [dev; @KERNEL-HENRY]"))
